"""Registered DreamerV4 and structured-v2 dynamics trainers.
...
@register("trainer", "dreamerv4_dynamics")
class DreamerV4DynamicsTrainer(_DynamicsTrainer):
    def train(self):
        return _run_dreamerv4(self.args, self.cfg)


@register("trainer", "structured_v2_dynamics")
class StructuredV2DynamicsTrainer(_DynamicsTrainer):
    def train(self):
