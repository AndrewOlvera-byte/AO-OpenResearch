"""Registered trainer for the discrete action-JEPA and next-code router."""
...
@register("trainer", "discrete_v3_action_tokenizer")
class DiscreteActionTokenizerTrainer:
...
def main(argv=None):
    ...
    trainer = DiscreteActionTokenizerTrainer(cfg, args)
